...
% 'neither'. If y is in the set {3, 6, 8, 9, 11}, then set B to true. If y 
% is in the set {2, 5, 7}, then set B to false. If y is neither, then set 
% B to the string 'neither'. You must use a switch statement to solve this 
% problem.(B) 
